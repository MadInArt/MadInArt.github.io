...
! function(t) {
    ...
    ! function() {
        ...
        e.Base.call(this), this.callActions("beforeConstruct"), this.enable = !0, this.live = !1, this.scope = "global", this.toggleLogic = "or", this.toggleDefault = ".cartoon", this.callActions("afterConstruct"), n.seal(this)
        ...
        e.Base.call(this), this.callActions("beforeConstruct"), this.filter = ".cartoon", this.sort = "default:asc", this.dataset = null, this.callActions("afterConstruct"), n.seal(this)
